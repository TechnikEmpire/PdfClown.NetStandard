...
//TODO:dictionary mandatory items (if any)!!!
  ...
  /**
    @return
      A {@link PdfDictionary}.
  */
  @Override
  public Object getValue(
    )
  {return getBaseDataObject().resolve(PdfName.V);}
  ...
  */
    ...
    )
  {
    if(!(value == null
      ...
      throw new IllegalArgumentException("Value MUST be a PdfDictionary");
      
    getBaseDataObject().put(PdfName.V, (PdfDictionary)value);
  }
  // </public>
  // </interface>
  // </dynamic>
