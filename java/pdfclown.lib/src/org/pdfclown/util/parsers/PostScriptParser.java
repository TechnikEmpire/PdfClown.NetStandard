  ...
  implements Closeable
{
  ...
  */
  ...
  /**
    ...
    character following the EOL sequence).
  ...
  */
  ...
  /**
    Moves the pointer after the current whitespace sequence (that is just before the non-whitespace
    character following the whitespace sequence).
